...
# Observations
The slope of processor energy with respect to time (seconds) is consistently ~0.5 for all experiments, save the high experiment upon navigation to the website. This suggests a baseline/background CPU power usage.

For the high experiments, there is a strong relationship between the CPU power consumption and the performance counters. The increase in the power consumption after website navigation, is directly attributable to the significant increase in the counters. 

However, for the low and medium cases, with significantly lower counters, there appears to be little change in the CPU power usage from the background. This suggests that the relationship is far from straightforward.
