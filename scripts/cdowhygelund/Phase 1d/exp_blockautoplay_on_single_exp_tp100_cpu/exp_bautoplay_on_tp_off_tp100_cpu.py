...
Same as exp_bautoplay_on_tp_off_tp100_cpu, except that CPU percentage is also measured
"""
...
def run_exp(exp_id, uris):
    ...
    exp = ExperimentTp100(
        ...
        sampled_data_retrievers=(sd.PerformanceProcessesRetriever(),
                                 sd.PsutilDataRetriever(method_names=('cpu_stats', 'cpu_times',
                                                                      'sensors_battery', 'cpu_freq', 'cpu_percent')),
