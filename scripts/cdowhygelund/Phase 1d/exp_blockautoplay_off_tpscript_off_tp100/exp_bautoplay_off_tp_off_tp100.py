...
To further investigate battery level effects observed from previous experiments. 
Specifically whether run order or battery charge influences the rate of 
battery usage. The idea is to have many runs across several charges and compare
how battery level and run correspond to net battery drain for a single URL navigation.
In addition the order of the URL loads has been randomized for each run. 
"""
